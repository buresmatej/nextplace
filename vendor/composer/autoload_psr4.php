...
return array(
    ...
    'Nette\\' => array($vendorDir . '/nette/utils/src', $vendorDir . '/nette/schema/src', $vendorDir . '/nette/robot-loader/src', $vendorDir . '/nette/neon/src', $vendorDir . '/nette/di/src', $vendorDir . '/nette/http/src', $vendorDir . '/nette/routing/src', $vendorDir . '/nette/component-model/src', $vendorDir . '/nette/php-generator/src', $vendorDir . '/nette/assets/src', $vendorDir . '/nette/bootstrap/src', $vendorDir . '/nette/caching/src', $vendorDir . '/nette/mail/src', $vendorDir . '/nette/application/src', $vendorDir . '/nette/database/src', $vendorDir . '/nette/forms/src', $vendorDir . '/nette/security/src'),
